...
#plot = plot_df.plot(kind='bar',figsize = (20,8),title='Feature Importance',fontsize=15)
#plot.axes.set_title("Feature Importance",fontsize=30)

#plot_df.index = ['DAY_OF_WEEK', 'DISTANCE', 'HourlyWindSpeed', 'Blowing', 'Snow', 'Thunder', 30, 31, 32, 35, 36, 37]


# COMMAND ----------


sns.barplot(x=list(range(0,38)), y= feature_importance_df['Importance_Score'])
...
shap_pandas_df = pd.DataFrame(shap_values.values)
